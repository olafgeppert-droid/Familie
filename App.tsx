...
const App: React.FC = () => {
  ...
  const [isSaving, setIsSaving] = useState(false); // ✅ Neuer State für Speichern-Status
  ...
  const handleSave = async () => {
    setIsSaving(true);
    try {
      // ✅ 1. Aktuellen State direkt in localStorage speichern
      const currentState = { people: state.people };
      localStorage.setItem('familyTreeState', JSON.stringify(currentState));
      
      // ✅ 2. Kurze Verzögerung für UI-Feedback
      await new Promise(resolve => setTimeout(resolve, 300));
      
      // ✅ 3. Erfolgsmeldung
      alert(`✅ Erfolgreich gespeichert! (${state.people.length} Personen)`);
      ...
      <div className="flex-grow flex overflow-hidden">
        ...
        <div className="flex-grow flex flex-col overflow-hidden">
          <Toolbar
            ...
            onRedo={redo}
            canRedo={canRedo}
            onSave={handleSave} // ✅ Neue onSave Prop
          />
